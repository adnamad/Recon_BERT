...
class FashionIQDataset(Dataset):
    ...
    def __init__(
        self, split: str = "train", dress_types=["dress", "shirt", "toptee"], mode: str = "relative", preprocess: callable = ToTensor()
    ):
        """
        ...
        try:
            if self.mode == "relative":
                ...
                if self.split == "train":
                    ...
                    # reference_image_path = base_path / "fashionIQ_dataset" / "images" / "245600258X.png"

                    reference_image = self.preprocess(PIL.Image.open(reference_image_path))
                    # print("AAA - ", reference_image.shape)
...
>>>>>>> 8f65dc7eff660ce77e68e1c30145204edf129e24
